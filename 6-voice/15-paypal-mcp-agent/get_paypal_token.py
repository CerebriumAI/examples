...
def get_paypal_access_token(client_id: str, client_secret: str, environment: str = "sandbox"):
    """
...
if __name__ == "__main__":
    ...
    if not client_id or not client_secret:
        print("Please set PAYPAL_CLIENT_ID and PAYPAL_CLIENT_SECRET environment variables")
        exit(1)
